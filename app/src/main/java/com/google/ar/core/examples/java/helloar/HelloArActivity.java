...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  public List<WrappedAnchor> getAnchors() {
  ...
  DumbAgent testAgent = new DumbAgent() ;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    testAgent.attachState(getAnchors()) ;
  ...
  public void onSurfaceCreated(SampleRender render) {
    ...
    try {
      ...
      // Virtual object to render (chair7)
    ...
    if (tap != null && camera.getTrackingState() == TrackingState.TRACKING) {
      ...
      for (HitResult hit : hitResultList) {
        ...
        if ((trackable instanceof Plane
          ...
          //int maxNumberOfAnchers = 20 ;
          int maxNumberOfAnchers = 4 ;
          if (wrappedAnchors.size() >= maxNumberOfAnchers) {
          ...
          //Log.d("COBA", "Adding a new anchor " + anchor.id) ;
          testAgent.update();
