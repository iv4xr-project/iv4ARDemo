...
public class MinimalAutonomousAgent {
    ...
    static public void main(String[] args) {
        ...
        Tactic.PrimitiveTactic guessing = action("guessing").do1((SimpleState belief) -> {
            int x = rnd.nextInt(5);
        ...
        // goal to it:
        AutonomousBasicAgent agent = new AutonomousBasicAgent().attachState(new State().setEnvironment(new ConsoleEnvironment()))
        ...
        GoalStructure gt = agent.waitUntilTheGoalIsConcluded();
