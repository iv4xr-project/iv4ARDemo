 ...
 * {@link #attachFileAsLogHandler(String)} to attach listeners to this logger.
...
public class Logging {
    ...
    /**
     * Attach {@code System.err} to listen to this agent's logger (also called
     * log-handler).
     */
     ...
     * logger (in Logging jargon, the file becomes a log handler). The filename can
     * include a path to the file.
     */
