...
public class GuessNumberGame {
    ...
    static public void main(String[] args) { // run this to run the demo
        ...
        Tactic.PrimitiveTactic asklb = action("askLowerBound").desc("Ask user to give a number less or equal that his secret number.")
                .do1((MyAgentState belief) -> {
                    String o = belief.env().ask("Type a number less or equal to your number:");
                    int i = toInt(o);
        ...
        MyAgentState belief = new MyAgentState();
        belief.setEnvironment(new ConsoleEnvironment());
        BasicAgent agent = new BasicAgent().attachState(belief).setGoal(topgoal);
